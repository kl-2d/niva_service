    ...
    <section className="py-24 bg-white border-t border-gray-200 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-[44px] left-[5%] right-[5%] h-[2px] bg-gray-200">
            <motion.div 
              initial={{ scaleX: 0 }}
              ...
              return (
                ...
                >
                  ...
                  {index !== steps.length - 1 && (
                    <div className="lg:hidden absolute left-12 w-[2px] h-20 bg-gray-200 -z-10 mt-16 ml-[-1px]"></div>
                  )}

                  {/* Icon Node */}
                  <div className="relative">
                    <div className="w-24 h-24 lg:w-24 lg:h-24 rounded-full bg-gray-50 border-2 border-gray-200 flex items-center justify-center shrink-0 group-hover:border-blue-500 transition-colors z-20 relative shadow-sm">
