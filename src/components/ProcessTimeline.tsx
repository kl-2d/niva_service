    ...
    <section className="py-24 bg-zinc-950 border-t border-zinc-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-[44px] left-[5%] right-[5%] h-[2px] bg-zinc-800">
            <motion.div 
              initial={{ scaleX: 0 }}
              ...
              return (
                ...
                >
                  ...
                  {index !== steps.length - 1 && (
                    <div className="lg:hidden absolute left-12 w-[2px] h-20 bg-zinc-800 -z-10 mt-16 ml-[-1px]"></div>
                  )}

                  {/* Icon Node */}
                  <div className="relative">
                    <div className="w-24 h-24 lg:w-24 lg:h-24 rounded-full bg-zinc-900 border-2 border-zinc-800 flex items-center justify-center shrink-0 group-hover:border-orange-500 transition-colors z-20 relative">
                      <Icon className="w-8 h-8 text-orange-500 group-hover:scale-110 transition-transform" />
                    </div>
                    
                    <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-orange-500 flex items-center justify-center font-bold text-white text-sm border-4 border-zinc-950">
                      {step.id}
                    </div>
                  </div>
