          ...
          <div className="lg:w-1/3">
            ...
            >
              ...
              <div className="bg-orange-50 border border-orange-100 rounded-xl p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-4 text-orange-700 font-semibold">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3 shrink-0">
                          <CheckCircle2 className="w-5 h-5 text-orange-200 group-hover:text-orange-500 transition-colors" />
                          <span className="text-stone-700 group-hover:text-stone-900 font-medium transition-colors">{item.title}</span>
                        </div>
                        
                        <div className="flex-grow border-b border-dotted border-stone-300 mb-1 opacity-50 group-hover:border-orange-300 transition-colors"></div>
