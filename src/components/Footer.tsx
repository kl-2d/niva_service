...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-zinc-800 pt-12 pb-8" id="contacts">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-zinc-400 mb-4 whitespace-pre-wrap">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex flex-col gap-2">
                <a href="tel:+79202295656" className="flex items-center gap-3 text-zinc-300 hover:text-white transition-colors">
                  <Phone className="w-5 h-5 text-orange-500 shrink-0" />
                  <span className="font-medium">+7 920 229-56-56</span>
                </a>
                <a href="tel:+74732361818" className="flex items-center gap-3 text-zinc-300 hover:text-white transition-colors">
                  <Phone className="w-5 h-5 text-orange-500 opacity-0 shrink-0" />
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-zinc-300">
                ...
                <div>
                  ...
                  <p>Сб: 10:00 - 16:00</p>
                  <p className="text-zinc-500 mt-1">Вс: Выходной</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="h-48 lg:h-auto rounded-lg overflow-hidden border border-zinc-800 relative bg-zinc-900">
            <iframe
