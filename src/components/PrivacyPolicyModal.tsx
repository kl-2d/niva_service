        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-stone-200 bg-stone-50 shrink-0">
              <h2 className="text-lg font-bold text-stone-900">Политика конфиденциальности</h2>
              <button
                onClick={onClose}
            ...
            {/* Content */}
            <div className="overflow-y-auto p-6 text-sm text-stone-700 space-y-5 leading-relaxed">
              <p className="text-xs text-stone-400">Последнее обновление: январь 2025 г.</p>

              <section>
                <h3 className="font-bold text-stone-900 mb-2">1. Общие положения</h3>
                <p>
              ...
              <section>
                <h3 className="font-bold text-stone-900 mb-2">2. Какие данные мы собираем</h3>
              ...
              <section>
                <h3 className="font-bold text-stone-900 mb-2">3. Цели использования данных</h3>
              ...
              <section>
                <h3 className="font-bold text-stone-900 mb-2">4. Хранение и защита данных</h3>
                <p>
              ...
              <section>
                <h3 className="font-bold text-stone-900 mb-2">5. Файлы cookie</h3>
                <p>
              ...
              <section>
                <h3 className="font-bold text-stone-900 mb-2">6. Ваши права</h3>
                <p>
              ...
              <section>
                <h3 className="font-bold text-stone-900 mb-2">7. Согласие</h3>
                <p>
