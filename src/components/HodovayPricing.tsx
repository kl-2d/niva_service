...
export default function HodovayPricing() {
  ...
  return (
    <section className="py-20 bg-[#E6E2DC] border-t border-[#D1CBC3]" id="hodovay-repair">
          ...
          <div className="lg:w-2/3 w-full">
            ...
            >
              <div className="p-6 md:p-8 bg-[#E6E2DC] border-b border-[#D1CBC3] flex justify-between items-center">
                ...
                <span className="text-xs text-[#6B635C] bg-white border border-[#D1CBC3] px-3 py-1 rounded-full shadow-sm">
                  Цены в рублях
                </span>
              </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3 shrink-0">
                          ...
                          <span className="text-[#6B635C] group-hover:text-[#1C1F23] font-medium transition-colors">
                            {item.title}
                          </span>
                        </div>

                        <div className="flex-grow border-b border-dotted border-[#D1CBC3] mb-1 opacity-50 group-hover:border-[#C8553D]/40 transition-colors" />
